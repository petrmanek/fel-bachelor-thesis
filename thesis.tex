...
\usepackage{courier}			%pro monospace font
...
\lstset{basicstyle=\footnotesize\ttfamily,breaklines=true,captionpos=b,frame=single}             % zápis úrvyků kódu


\pgfdeclarelayer{background}
\pgfsetlayers{background,main}                          % pozadí+popředí tikz
...
\include{appendix_creation_scripts}
