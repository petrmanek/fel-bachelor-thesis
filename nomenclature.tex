...
\nomenclature	{LHC}		{Large Hadron Collider, an experimental facility built by CERN.}
\nomenclature	{LS}		{Long Shutdown, a period in CERN time schedule characteristic by temporary cessation of operation of particle accelerators and increased maintenance.}
\nomenclature	{ROOT}		{An object oriented data analysis framework. \cite{ROOT}}
\nomenclature	{DCS}		{Detector Control Systems, a system providing control of sub-detectors and of common infrastructure of the experiment and communication with the services of CERN.}
...
\nomenclature	{TPX}		{Timepix, a semiconductor pixel detection chip succeeding Medipix2.}
